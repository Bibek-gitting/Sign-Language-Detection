...
while True:
    ...
    # cv2.putText(frame, "del : "+str(count['del']), (10, 350), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,255), 1)
    # cv2.putText(frame, "space : "+str(count['space']), (10, 360), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,255), 1)
    row = frame.shape[1]
    col = frame.shape[0]
